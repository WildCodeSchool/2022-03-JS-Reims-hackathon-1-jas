      ...
      <div className="details-container">
        <details>
          ...
          <p className="did-you-know">
            ...
            permet pas de créer de la pâte à papier. Les déchets de bois ont
            deux débouchés principaux : la valorisation matière dans l’industrie
            des panneaux de particules et la valorisation énergétique en
            chaufferie.
          </p>
        </details>
      </div>
